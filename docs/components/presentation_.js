import*as m from"../web_modules/react.js";import*as t from"../web_modules/spectacle.js";import*as e from"../a_.js";import*as f from"../assets/emotion.webp.proxy.js";import*as S from"../assets/photo.jpg.proxy.js";import*as g from"../lib/component_.js";import*as s from"../lib/style_.js";const u=({children:i})=>e.cE(s.themeProvider,{theme:(()=>{const c=s.useTheme();return m.useMemo(()=>({...c,colors:{...c.colors,background:"#1f1b21",foreground:"white"}}),[c])})(),children:i}),b=({children:i})=>e.cE("div",{className:(()=>{const c=s.useTheme().colors;return s.useStyles({display:"flex",width:"100%",height:"100%",justifyContent:"center",alignItems:"center",paddingLeft:64,paddingRight:64,paddingTop:128,paddingBottom:128,backgroundColor:c.background,color:c.foreground},[c])})(),children:i}),y=({children:i})=>e.cE("div",{className:s.useStyles({fontSize:64,fontVariationSettings:'"wght" 500',textAlign:"center"},[]),children:i}),N=({children:i})=>e.cE("span",{className:s.useStyles({textDecoration:"line-through"},[]),children:i}),l=({children:i})=>e.cE("div",{className:(()=>{const c=s.useTheme().colors;return s.useStyles({display:"grid",gridGap:32,width:"100%",height:"100%",paddingLeft:64,paddingRight:64,paddingTop:128,paddingBottom:128,backgroundColor:c.background,color:c.foreground},[c])})(),children:i}),n=({children:i})=>e.cE("div",{className:s.useStyles({fontSize:64},[]),children:i}),A={space:[0,0,0],size:{maxCodePaneHeight:500}},a=({children:i,small:c})=>e.cE("ul",{className:s.useStyles({display:"grid",gridGap:32,fontSize:c?36:48,margin:0},[c]),children:i}),o=({onClick:i,children:c})=>e.cE("li",[e.cE("div",{onClick:i,className:s.useStyles({display:"grid",gridGap:32},[]),children:c})]),w=({image:i,children:c})=>e.cE("div",{className:s.useStyles({display:"grid",gridAutoFlow:"column",gridGap:32},[])},[c,i]),C=({src:i})=>e.cE("img",{className:s.useStyles({borderRadius:"100%",overflow:"hidden"},[]),src:i}),d=({includeBackground:i,children:c})=>e.cE(s.themeProvider,{theme:(()=>{const r=s.useTheme();return m.useMemo(()=>({...r,colors:{...r.colors,...i?{background:"#f1e8e3"}:{},foreground:"#ff5e00"}}),[r])})(),children:c}),E=({children:i})=>e.cE("div",{className:s.useStyles({fontSize:48},[]),children:i}),k=()=>e.cE("img",{className:s.useStyles({width:36,height:36},[]),src:f.default}),p=({children:i})=>e.cE("div",{className:s.useStyles({display:"flex",alignItems:"center",fontSize:96},[]),children:i}),h=({to:i})=>e.cE("a",{className:s.useStyles({color:"white"},[]),href:i,target:"_blank",rel:"noopener noreferrer",children:i}),x=i=>Array.from({length:i}).map((c,r)=>r);export const presentation=()=>e.cE("div",{className:s.useStyles({fontFamily:"Inter"},[])},[e.cE(t.Deck,{theme:A,transitionEffect:"none"},[e.cE(t.Slide,[e.cE("div"),e.cE(t.Stepper,{values:x(2),children:(i=-1)=>e.cE(u,[e.cE(b,[e.cE(y,[e.cE("span",["Let's "]),["build",e.cE(N,["build"]),"design"][i+1],e.cE("span",[" a CSS-in-JS library!"])])])])})]),e.cE(t.Slide,[e.cE(l,[e.cE(n,["A little bit about me"]),e.cE(w,{image:e.cE(t.Appear,{elementNum:0},[e.cE(C,{src:S.default})])},[e.cE(a,[e.cE(t.Appear,{elementNum:0},[e.cE(o,["Lewis Liu"])]),e.cE(t.Appear,{elementNum:1},[e.cE(o,["~ 2.5 years of frontend at Brex"])]),e.cE(t.Appear,{elementNum:2},[e.cE(o,["Previously at CircleCI",e.cE(a,[e.cE(o,["Full stack Clojure/ClojureScript"]),e.cE(o,["Recently 🌅 at Brex"])])])])])])])]),e.cE(t.Slide,[e.cE(d,{includeBackground:!0},[e.cE(l,[e.cE(n,["Let's design a CSS-in-JS library!"]),e.cE(t.Appear,{elementNum:0},[e.cE(E,["...but why? 🤔"])])])])]),e.cE(t.Slide,[e.cE(l,[e.cE(n,["Background"]),e.cE(t.Appear,{elementNum:0},[e.cE(E,["We use Emotion ",e.cE(k)," for CSS-in-JS"])]),e.cE(a,[e.cE(t.Appear,{elementNum:1},[e.cE(o,["🥇 imported library (not counting React)"])]),e.cE(t.Appear,{elementNum:2},[e.cE(o,["Often treated like a black box"])]),e.cE(t.Appear,{elementNum:3},[e.cE(o,["Best way to demystify: rebuild from first-principles"])])])])]),e.cE(t.Slide,[e.cE(d,[e.cE(l,[e.cE(p,["Redesign, not rebuild"])])])]),e.cE(t.Slide,[e.cE(l,[e.cE(n,["How can we improve on Emotion?"]),e.cE(a,[e.cE(t.Appear,{elementNum:0},[e.cE(o,['Designed in the "pre React hooks era"'])]),e.cE(t.Appear,{elementNum:1},[e.cE(o,["Paradigm shift => opportunity for new APIs"])]),e.cE(t.Appear,{elementNum:2},[e.cE(o,["We're still in an API design gold rush",e.cE(a,[e.cE(o,["Lots of low hanging fruits"])])])])])])]),e.cE(t.Slide,[e.cE("div"),e.cE(t.Stepper,{defaultValue:[4,9],values:[[4,4],[13,13],[4,4],[13,13]],children:([i,c])=>e.cE(l,[e.cE(n,["How can we improve on Emotion?"]),e.cE(t.CodePane,{highlightStart:i,highlightEnd:c,autoFillHeight:!0,fontSize:26,indentSize:1},[`
...
const NotAlwaysVisible = () => {
  ...
  return <SometimesVisible visible={visible} />
                ...
                `])])})]),e.cE(t.Slide,[e.cE(d,[e.cE(l,[e.cE(p,[`"It's just another variable"`])])])]),e.cE(t.Slide,[e.cE("div"),e.cE(t.Stepper,{defaultValue:[],values:[[4,5],[12,13],[4,5],[4,5],[4,5]],children:([i,c],r)=>e.cE(l,[e.cE(n,["Forced indirection"]),e.cE(t.CodePane,{highlightStart:i,highlightEnd:c,autoFillHeight:!0,fontSize:26,indentSize:1},(()=>{const v=["SometimesVisible","SometimesVisible","Wrapper","Container","NotAlwaysVisibleContainer"][r]||"SometimesVisible";return[`
type Props = { visible: boolean }
